...
func main() {
	...
	server.RegisterMethod("email.catchall.set", email.HandleCatchAllSet)
	server.RegisterMethod("email.catchall.delete", email.HandleCatchAllDelete)
	...
	server.RegisterMethod("backup.schedule.create", backup.HandleBackupScheduleCreate)
	server.RegisterMethod("backup.schedule.delete", backup.HandleBackupScheduleDelete)
	server.RegisterMethod("cron.create", cron.HandleCronCreate)
	server.RegisterMethod("cron.delete", cron.HandleCronDelete)
	server.RegisterMethod("cron.update", cron.HandleCronUpdate)
	server.RegisterMethod("cron.enable", cron.HandleCronEnable)
	server.RegisterMethod("cron.disable", cron.HandleCronDisable)
